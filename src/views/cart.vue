			...
			<div class="cart-box">
							...
							<div class="cart-group">
								...
								<div class="cart-top-items" v-for="item,index in carPanelData">
									<div class="cart-items">
										...
										<div class="operation">
											<a class="items-delete-btn" @click="delCarPanelHander(item.sku_id)"></a>
										</div>
										...
										<div class="item-cols-num">
											<div class="select js-select-quantity">
												...
												<span class="up" :class="{'up-disabled':item.count>=item.limit_num}" @click="plusCarPanelData(item.sku_id)">+</span>
											</div>
										</div>
				...
				<div class="cart-bottom-bg fix-bottom" v-if="count>0">
					<div class="cart-bar-operation">
						<div>
							<div class="choose-all js-choose-all">
								<span class="blue-checkbox-new" :class="{'checkbox-on':allChecked}" @click="allGoodsCheckHandle(allChecked)"></span><a></a>
								全选
							</div>
					...
					<div class="shipping">
						...
						<router-link tag = "span" class="jianguo-blue-main-btn big-main-btn js-checkout" to="/checkout" :class="{'disabled-btn' :checkedCount <=0 }"><a>现在结算</a></router-link>
...
<script>
	...
	export default {
		...
		methods: {
			...
			allGoodsCheckHandle(allChecked) {
				this.$store.commit('allGoodsCheckHandle', allChecked)
			},
			delCheckGoods() {
